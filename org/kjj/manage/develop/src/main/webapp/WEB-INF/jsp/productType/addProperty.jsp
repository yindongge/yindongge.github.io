		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
					...
					<div class="row">
						<div class="col-md-10 col-md-offset-1">							
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" id="propertyName" name="propertyName" placeholder="名称" required data-bv-notempty-message="名称不能为空"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label">排序：</label>
									<div class="col-md-8">
										<input type="text" class="form-control" id="propertyOrder" name="propertyOrder" placeholder="排序" required data-bv-notempty-message="排序不能为空" pattern="^[0-9]*$" data-bv-regexp-message="必须为数字"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label"><i
				...
				<div class="modal-footer">
					...
					<input type="submit" class="btn btn-primary modal-button" onclick="attrParent();" value="确定"></input>
				</div>
			</div>
			</form>
		</div>
...
<script src="${jsBase}/productType/addProperty.js" type="text/javascript"></script>
</body>
</html>