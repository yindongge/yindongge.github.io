		...
		<div class="container-fluid ">
			<div class="row alertcontrol">
				...
				<div class="col-sm-5 text-center">
					<div class="yiweima"><img src='${ctx}/order/code/${order.orderId}'/></div>
				</div>
			</div>
			<div class="row row6" style="margin-bottom:10px;">
				<div class="col-sm-6">
					<span>客户姓名：</span>
			...
			<div class="row row6">
				...
				<div class="col-sm-6">
					<span>店铺名称：</span>
					<span>${order.orgShop.shopName}</span>
				</div>
				<div class="col-sm-6">
					<span>商品总数：</span>
