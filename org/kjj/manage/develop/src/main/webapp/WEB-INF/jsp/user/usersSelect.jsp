...
<div class="container-fluid">
	<form id="pageform" name="pageform"  class="form-inline" method="post" action="${ctx}/user/select">
	...
	<br/>
	<div class="breadcrumb breadcrumb-title">会员列表 
		    <button type="button" class="btn btn-danger"  onclick="doSelect()">选择</button></div>
