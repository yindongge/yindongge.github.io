...
public class OrgUserLevelCouponVo extends OrgUserLevelCoupon {
	/** 商品的唯一货号 */
	...
	/** 折扣列表 */
	private List<OrgUserLevelCouponDiscount> discountList;
	...
	public List<OrgUserLevelCouponDiscount> getDiscountList() {
		return discountList;
	}

	public void setDiscountList(List<OrgUserLevelCouponDiscount> discountList) {
