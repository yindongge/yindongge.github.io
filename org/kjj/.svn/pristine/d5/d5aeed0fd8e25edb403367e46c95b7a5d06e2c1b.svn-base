				...
				<div class="mlist information " >
					...
					<div class="safeset">
						<form id="defaultForm">
							...
							<div class="form-list">
								<div class="form-left"> 手机号： </div>
								<div class="form-center">
									<input type="text" name="mobilePhone" id="mobilePhone" placeholder="手机号"/>
								</div>
								<div class="form-right" id="mobileShow"></div>
							</div>
							<div class="form-list">
								<div class="form-left"> 验证码： </div>
								<div class="form-center">
									<input type="text" name="verifycode" id="verifycode" class="f-special1"/>
