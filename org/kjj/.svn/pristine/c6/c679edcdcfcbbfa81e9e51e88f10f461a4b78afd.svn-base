...
public class OrgOrderReportServiceImpl implements OrgOrderReportService{
	...
	public String exportOrderExcel(OrgOrderReportQuery query) {
		...
		// 查询到所有企业和所有企业关联用户
		Map<String, OrgEnterprise> enterpriseMap = orgEnterpriseService.queryMap(new OrgEnterprise(), "enterpriseId");
		
		Map<Integer, OrgEnterpriseUser> oeuMap = orgEnterpriseUserService.queryMap(new OrgEnterpriseUser(), "userId");
		
		//创建表头
		HSSFRow rowHead = sheet.createRow(0);
		String[] heads = {"订单编号","会员名","公司名称","店铺","下单时间","支付时间","商品名称","商品属性","原价","折扣价","购买数量","订单状态","所在地区","收货地址","收货人姓名","手机号","邮箱","附言","来源"};
		...
		if (listOrderGoods.size() > 0) {
			...
			for (int i = 0; i < listOrderGoods.size(); i++) {
				...
				if(null != oeuMap.get(orgOrderGoodsOrderReportVo.getUserId())){
					cell2.setCellValue(enterpriseMap.get(oeuMap.get(orgOrderGoodsOrderReportVo.getUserId()).getEnterpriseId()).getEnterpriseName());
				} else {
					cell2.setCellValue("");
				}
				...
				cell3.setCellValue(orgOrderGoodsOrderReportVo.getShopName());

				HSSFCell cell4 = rowData.createCell(4);
				cell4.setCellType(HSSFCell.CELL_TYPE_STRING);
				cell4.setCellValue(DateFormatUtil.formatDateTime(orgOrderGoodsOrderReportVo.getOrgOrder().getCreateTime()));

				HSSFCell cell5 = rowData.createCell(5);
				cell5.setCellType(HSSFCell.CELL_TYPE_STRING);
				cell5.setCellValue(DateFormatUtil.formatDateTime(orgOrderGoodsOrderReportVo.getOrgOrder().getPayTime()));

				HSSFCell cell6 = rowData.createCell(6);
				cell6.setCellType(HSSFCell.CELL_TYPE_STRING);
				cell6.setCellValue(orgOrderGoodsOrderReportVo.getOrgProductItem().getGoodsName());
				...
				cell8.setCellValue(orgOrderGoodsOrderReportVo.getUnitAccounts().doubleValue());

				HSSFCell cell9 = rowData.createCell(9);
				cell9.setCellType(HSSFCell.CELL_TYPE_STRING);
				cell9.setCellStyle(cellStyle);
				cell9.setCellValue(orgOrderGoodsOrderReportVo.getUnitPrice().doubleValue());

				HSSFCell cell10 = rowData.createCell(10);
				cell10.setCellType(HSSFCell.CELL_TYPE_STRING);
				cell10.setCellValue(orgOrderGoodsOrderReportVo.getAmount());
				...
				case 0:
					cell11.setCellValue("待付款");
					break;
				case 1:
					cell11.setCellValue("待确认");
					break;
				case 2:
					if(orgOrderGoodsOrderReportVo.getOrgOrder().getSendStyle() == 0){
						cell11.setCellValue("待发货");
						break;
					}
						cell11.setCellValue("备货中");
						break;
				case 3:
					if(orgOrderGoodsOrderReportVo.getOrgOrder().getSendStyle() == 0){
						cell11.setCellValue("待收货");
						break;
					}
						cell11.setCellValue("待自提");
						break;
				case 4:
					cell11.setCellValue("已完成");
					break;
				case 5:
					cell11.setCellValue("已取消");
					break;
				case 6:
					cell11.setCellValue("已关闭");
					break;
				default:
					cell11.setCellValue("");
					break;
		...
		String[] heads2 = { "订单编号", "会员名/手机号", "公司名称", "店铺", "配送方式", "支付方式", "下单时间",
		...
		if (orderList.size() > 0) {
			...
			for (int i = 0; i < orderList.size(); i++) {
				...
				if(null != oeuMap.get(orgOrderVo.getUserId())){
					cell2.setCellValue(enterpriseMap.get(oeuMap.get(orgOrderVo.getUserId()).getEnterpriseId()).getEnterpriseName());
				} else {
					cell2.setCellValue("");
				}
				...
				cell3.setCellValue(orgOrderVo.getOrgShop().getShopName());
				...
				case 0:
					cell4.setCellValue("送货上门 ");
					break;
				case 1:
					cell4.setCellValue("到店自取");
					break;
				default:
					cell4.setCellValue("");
					break;
				...
				cell5.setCellValue(payStyle);
				
				sheet2.addMergedRegion(new CellRangeAddress(rowNum, rowNum+listOrderGoods.size()-1, 6, 6));
				HSSFCell cell6 = rowData.createCell(6);
				cell6.setCellType(HSSFCell.CELL_TYPE_STRING);
				cell6.setCellStyle(style);
				cell6.setCellValue(DateFormatUtil.formatDateTime(orgOrderVo.getCreateTime()));

				sheet2.addMergedRegion(new CellRangeAddress(rowNum, rowNum+listOrderGoods.size()-1, 7, 7));
				HSSFCell cell7 = rowData.createCell(7);
				cell7.setCellType(HSSFCell.CELL_TYPE_STRING);
				cell7.setCellStyle(style);
				cell7.setCellValue(DateFormatUtil.formatDateTime(orgOrderVo.getPayTime()));
				...
				for (int j = 0; j < listOrderGoods.size(); j++) {
					...
					if (j == 0) {
						...
						cell8.setCellValue(null == orgOrderGoodsVo.getOrgProductItem().getGoodsName() ? "":orgOrderGoodsVo.getOrgProductItem().getGoodsName());
						...
						cell10.setCellValue(orgOrderGoodsVo.getUnitAccounts().doubleValue());

						HSSFCell cell11 = rowData.createCell(11);
						cell11.setCellType(HSSFCell.CELL_TYPE_STRING);
						cell11.setCellStyle(cellStyle);
						cell11.setCellValue(orgOrderGoodsVo.getUnitPrice().doubleValue());

						HSSFCell cell12 = rowData.createCell(12);
						cell12.setCellType(HSSFCell.CELL_TYPE_STRING);
						cell12.setCellValue(orgOrderGoodsVo.getAmount());
						...
						HSSFCell cell12 = rowGoodsData.createCell(12);
						cell12.setCellType(HSSFCell.CELL_TYPE_STRING);
						cell12.setCellValue(orgOrderGoodsVo.getAmount());
					}
				...
				case 0:
					cell17.setCellValue("待付款");
					break;
				case 1:
					cell17.setCellValue("待确认");
					break;
				case 2:
					if(orgOrderVo.getSendStyle() == 0){
						cell17.setCellValue("待发货");
						break;
					}
						cell17.setCellValue("备货中");
						break;
				case 3:
					if(orgOrderVo.getSendStyle() == 0){
						cell17.setCellValue("待收货");
						break;
					}
						cell17.setCellValue("待自提");
						break;
				case 4:
					cell17.setCellValue("已完成");
					break;
				case 5:
					cell17.setCellValue("已取消");
					break;
				case 6:
					cell17.setCellValue("已关闭");
					break;
				default:
					cell17.setCellValue("");
					break;
				...
				cell18.setCellValue(orgOrderVo.getShow());
				...
				cell19.setCellValue(orgOrderVo.getConsigneeAddress());
				...
				cell20.setCellValue(orgOrderVo.getConsignee());
				...
				cell21.setCellValue(orgOrderVo.getConsigneeMobile());
				...
				cell22.setCellValue(orgOrderVo.getConsigneeEmail());
				...
				cell23.setCellValue(orgOrderVo.getInvoice());
				...
				sheet2.addMergedRegion(new CellRangeAddress(rowNum, rowNum+listOrderGoods.size()-1, 25, 25));
				HSSFCell cell25 = rowData.createCell(25);
		...
		String[] heads3 = {"退款单号","订单号","退货单号","会员名","公司名称","退款方式","在线退款方式","退款状态","退款金额","创建时间","退款操作人","退款时间"};
		...
		for (int i = 0; i < refundOrderList.size(); i++) {
		    ...
		    cell4.setCellType(HSSFCell.CELL_TYPE_STRING);
		    cell4.setCellStyle(style);
		    if(null != oeuMap.get(orgRefundOrderVo.getUserId())){
				cell4.setCellValue(enterpriseMap.get(oeuMap.get(orgRefundOrderVo.getUserId()).getEnterpriseId()).getEnterpriseName());
			} else {
				cell4.setCellValue("");
			}
		    ...
		    case 0:
		    	cell5.setCellValue("在线");
		    	break;
		    case 1:
		    	cell5.setCellValue("本地");
		    	break;
		    case 2:
		    	cell5.setCellValue("预");
		    	break;
		    default:
		    	cell5.setCellValue("");
		    	break;
		    ...
		    if(null != orgRefundOrder.getOnlineRefundStyle()){
		    	...
		    	case 1:
		    		cell6.setCellValue("支");
		    		break;
		    	case 2:
		    		cell6.setCellValue("微信");
		    		break;
		    	case 3:
		    		cell6.setCellValue("财");
		    		break;
		    	case 4:
		    		cell6.setCellValue("银联");
		    		break;
		    	case 5:
		    		cell6.setCellValue("微信");
		    		break;
		    ...
		    case 0:
		    	cell7.setCellValue("退款中");
		    	break;
		    case 1:
		    	cell7.setCellValue("退款完成");
		    	break;
		    default:
		   		cell7.setCellValue("");
		   		break;
		    ...
		    cell8.setCellType(HSSFCell.CELL_TYPE_STRING);
		    cell8.setCellStyle(cellStyle);
		    cell8.setCellValue(orgRefundOrder.getRefundMoney().doubleValue());
		    
		    HSSFCell cell9 = rowData.createCell(9);
		    cell9.setCellType(HSSFCell.CELL_TYPE_STRING);
		    cell9.setCellStyle(style);
	    	cell9.setCellValue(DateFormatUtil.formatDateTime(orgRefundOrder.getCreateTime()));
		    
		    HSSFCell cell10 = rowData.createCell(10);
		    cell10.setCellType(HSSFCell.CELL_TYPE_STRING);
		    cell10.setCellStyle(style);
		    cell10.setCellValue(StringUtils.isBlank(orgRefundOrderVo.getAdminName()) ? "系统" : orgRefundOrderVo.getAdminName());
		    
		    HSSFCell cell11 = rowData.createCell(11);
		    cell11.setCellType(HSSFCell.CELL_TYPE_STRING);
		    cell11.setCellStyle(style);
	    	cell11.setCellValue(DateFormatUtil.formatDateTime(orgRefundOrder.getRefundTime()));
		}
