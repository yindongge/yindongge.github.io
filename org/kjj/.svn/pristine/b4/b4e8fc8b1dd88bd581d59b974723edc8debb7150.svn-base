...
function commit(){
	...
	if(pass1==""){
		...
		$("#passwordshow").html("<p class='false'><span class='glyphicon glyphicon-remove-sign'></span>请填写6位密码！</p>");	
		return false;
	}
	if(pass1.length<6||pass1.length>6){
		$("#passwords").html("<p class='false'><span class='glyphicon glyphicon-remove-sign'></span> 密码长度为6的字符串！</p>");
		return false;
	}
