					...
					<div class="safeset">
						<form id="form" >
							...
							<div class="form-list">
								...
								<div class="form-center">
									<input type="password" name="payPassword" id="password" value="" maxlength="6" autocomplete="off" onblur="checkPassword()" placeHolder="密码长度为6位数字"/>
								</div>
							...
							<div class="form-list"> 
								...
								<div class="form-center">
									<input type="password" id="confirmpass" name="confirmpass" value="" maxlength="6" autocomplete="off" onblur="checkConfirmPassword()" placeHolder="密码长度为6位数字"/>
								</div>
