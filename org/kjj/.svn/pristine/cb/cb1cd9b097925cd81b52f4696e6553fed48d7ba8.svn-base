...
<div class="all">
	...
	<div class="header">
		<div class="container container-width margin-control">
			...
			<div class="right-tip">
				<p>已有账号？现在<a href="${ctx}/loginInit">登录</a></p>
			</div>
		</div>
	</div>
	<div class="regin_wrapper">
		<div class="regin_content">
		<div class="regin new">
		<div class="regin_mask"></div>
			<form id="form">
				<div class="form-list">
					<div class="form-center" id="userdiv">
					<span class="form_tip">手机号：</span>
						<input type="text" id="mobilePhone" name="mobilePhone" oninput="check()" placeholder="建议使用常用手机"/>
					</div>
					<div class="check-mistake"><span class="white" id="phoneShow"></span></div>
				</div>
				<div class="form-list" id="codediv">
					<div class="form-center">
					<span class="form_tip">验证码：</span>
						<input type="text"  name="verifycode" id = "verifycode" class="f-special1" placeholder="短信验证码"/>
						<button type="button" id="bsend" class="btn btn-primary reverse_blue" onclick="sendMessage(this)">免费获取验证码</button>
					</div>
					<div class="check-mistake"><span class="white" id="showvcode"></span></div>
				</div>
				<div class="form-list">
					<div class="form-center" id="pass1div">
					<span class="form_tip">密&nbsp;&nbsp;&nbsp;码：</span>
						<input type="password"  id="password" name="password" placeholder="建议使用字母和数字组合"/>
					</div>
					<div class="check-mistake"><span class="white" id="passwordshow"></span></div>
				</div>
				<div class="form-list">
					<div class="form-center" id="pass2div">
					<span class="form_tip">确认密码：</span>
						<input type="password"  id="confirmpassword" name="confirmpassword" placeholder="请再次输入密码"/>
					</div>
					<div class="check-mistake"><span class="white" id="password2show"></span></div>

				</div>
				<div class="form-list h50">
					<div class="form-center">
...
<!-- 			</div> -->
<!-- 		</div> -->
		<div class="a_link_regin">
					<a href="${ctx}/register/preEnterpriseReg"></a>
		</div>
		<div class="regin_icon_dunpai"></div>
	</div>
	</div>
