	...
	<div class="page-wrapper">
		<div class="container-fluid">
			<ul class="breadcrumb">
				<li>您的位置</li>
				<li ><a href="#">店铺</a></li>
				<li class="active">触摸屏首页管理</li>
			</ul>
		<form class="form-inline clear-control" id ="pageform" name ="pageform" action="${ctx}/touchPage/list" method="post">
...
<script src="${jsBase}/touchPage/touchPageList.js" type="text/javascript"></script>
</body>
</html>
