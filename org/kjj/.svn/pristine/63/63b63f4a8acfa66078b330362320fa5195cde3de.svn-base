	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group" style="display: none;" id="giveTypePart">
				...
				<div class="col-sm-9">
					<div class="col-sm-12">
						<textarea rows="5" style="width:50%;resize: none;" placeholder="请输入用户名、用户ID或用户手机号,多个会员请用半角逗号隔开" name="userQuery" maxlength="200" onkeyup="checkTextAreaLength(this,200)" onblur="checkTextAreaLength(this,200)"
