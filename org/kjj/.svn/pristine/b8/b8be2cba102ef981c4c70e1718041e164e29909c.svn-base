	...
	<form id="adminForm" method="post">
		...
		<table class="table table-hover table-bordered ">
			<tbody>
				<tr>
					<td>*用户名</td>
					<td style="text-align:left; "> <input type="text" name="userName" id="userName" value="${query.userName }"/></td>
				</tr>
				<tr>
					<td>*密码</td>
					<td style="text-align:left;  "> 	
						<input rows="5" style="width:35%" name="password" value="${query.password }" id="password"/>
					</td>
				</tr>
				...
				<tr>
					<td>*手机号</td>
					<td style="text-align:left;  "> 	
						<input rows="5" style="width:35%" name="email" id="email" value="${query.email}"/>
					</td>
				</tr>
...
<script src="${jsBase}/admin/add.js" type="text/javascript"></script>
</body>
</html>
