package com.kjj.mobile.pay.alipay.util;
...
import com.kjj.mobile.pay.alipay.config.AlipayConfig;
import com.kjj.mobile.pay.alipay.sign.MD5;
import com.kjj.mobile.pay.alipay.util.httpClient.HttpProtocolHandler;
import com.kjj.mobile.pay.alipay.util.httpClient.HttpRequest;
import com.kjj.mobile.pay.alipay.util.httpClient.HttpResponse;
import com.kjj.mobile.pay.alipay.util.httpClient.HttpResultType;
