...
public class OrgProductItem {
    ...
    /** 0库存是否显示：1显示0不显示 */
    private Byte isShowZeroInventory;
    
    /** 是否直营 0：直营 1：联营 */
    private Byte isDirect;

    /** 最近一次交易快照id */
    private Integer lastTradeSnapshootId;
    ...
    public Byte getIsShowZeroInventory() {
        return isShowZeroInventory;
    }

    public void setIsShowZeroInventory(Byte isShowZeroInventory) {
        this.isShowZeroInventory = isShowZeroInventory;
    }
	...
	public Integer getLastTradeSnapshootId() {
        return lastTradeSnapshootId;
    }

    public void setLastTradeSnapshootId(Integer lastTradeSnapshootId) {
        this.lastTradeSnapshootId = lastTradeSnapshootId;
    }
    ...
    public boolean equals(Object that) {
        ...
        OrgProductItem other = (OrgProductItem) that;
        return (this.getGoodsId() == null ? other.getGoodsId() == null : this.getGoodsId().equals(other.getGoodsId()))
            && (this.getParentGoodsId() == null ? other.getParentGoodsId() == null : this.getParentGoodsId().equals(other.getParentGoodsId()))
            ...
            && (this.getIsShowZeroInventory() == null ? other.getIsShowZeroInventory() == null : this.getIsShowZeroInventory().equals(other.getIsShowZeroInventory()))
            && (this.getIsDirect() == null ? other.getIsDirect() == null : this.getIsDirect().equals(other.getIsDirect()))
            && (this.getLastTradeSnapshootId() == null ? other.getLastTradeSnapshootId() == null : this.getLastTradeSnapshootId().equals(other.getLastTradeSnapshootId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getParentGoodsId() == null) ? 0 : getParentGoodsId().hashCode());
        ...
        result = prime * result + ((getIsShowZeroInventory() == null) ? 0 : getIsShowZeroInventory().hashCode());
        result = prime * result + ((getIsDirect() == null) ? 0 : getIsDirect().hashCode());
        result = prime * result + ((getLastTradeSnapshootId() == null) ? 0 : getLastTradeSnapshootId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", parentGoodsId=").append(parentGoodsId);
        ...
        sb.append(", isShowZeroInventory=").append(isShowZeroInventory);
        sb.append(", isDirect=").append(isDirect);
        sb.append(", lastTradeSnapshootId=").append(lastTradeSnapshootId);
