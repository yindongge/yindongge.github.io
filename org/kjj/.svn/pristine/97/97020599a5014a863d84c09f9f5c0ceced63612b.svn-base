...
public class OrgUsersDaoImpl extends BaseDaoImpl<OrgUsers, Integer> implements OrgUsersDao {
	...
	private static final String SQL_ID_UPDATE_OPENID_FOR_USER = "updateOpenIdForUser";
	...
	public int updateOpenId4User(String openId) {
		...
		return sqlSession.update(getSqlName(SQL_ID_UPDATE_OPENID_FOR_USER), parameter);
	}
}