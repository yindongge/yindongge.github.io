...
public class MealController {
	...
	@Resource
	private OrgProductShopSaleService orgProductShopSaleService;
	...
	public Map<String,Object> updateStatus(Model model,Integer id,Integer inventoryId,Byte status) {
		Integer newId = orgProductShopSaleService.updateStatusById(id,inventoryId,status);
