...
public class KindEditorController {
	...
	/**
	    ...
	    public void file_upload(HttpServletRequest request, HttpServletResponse response) throws Exception{
	          	...
	          	String savePath=UploadConstant.KINDEDITOR_UPLOAD_BASE_PATH+"/";
	            // 文件保存目录URL
	            String saveUrl="/";
	            // 定义允许上传的文件扩展名
	            ...
	            obj.put("error", 0);
	            obj.put("url", UploadConstant.KINDEDITOR_UPLOAD_BASE_URL+"/"+saveUrl + newFileName);
...
//	            String rootPath = application.getRealPath("/") + "upload/";
	            String rootPath = UploadConstant.KINDEDITOR_UPLOAD_BASE_PATH+"/";
	            // 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/upload/
//	            String rootUrl = request.getContextPath() + "/upload/";
	            String rootUrl = UploadConstant.KINDEDITOR_UPLOAD_BASE_URL+"/";
	            // 图片扩展名
