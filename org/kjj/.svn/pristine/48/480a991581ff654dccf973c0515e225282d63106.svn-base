		...
		<form id="roleForm" method="post">
			...
			<table class="table table-hover table-bordered ">
				<tbody>
					<tr>
						<td>*角色名称</td>
						<td style="text-align:left; "> <input type="text" id="roleName" name="roleName"
						required data-bv-notempty-message="角色名称不能为空"/></td>
					</tr>
					<tr>
						<td>角色备注</td>
						<td style="text-align:left;  "> 	
							<textarea rows="5" style="width:35%" name="remarkname"></textarea>
						</td>
					</tr>
						<tr>
						<td>分配权限:</td>
...
<script src="${jsBase}/role/add.js" type="text/javascript"></script>
</body>
</html>
