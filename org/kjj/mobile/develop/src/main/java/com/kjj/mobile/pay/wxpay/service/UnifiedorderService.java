package com.kjj.mobile.pay.wxpay.service;
...
import com.kjj.mobile.pay.wxpay.data.UnifiedorderReqData;
import com.kjj.mobile.pay.wxpay.data.UnifiedorderRespData;
import com.kjj.mobile.pay.wxpay.util.Util;
...
public class UnifiedorderService extends BaseService{
	 ...
	 * @return
	 */
	public UnifiedorderRespData pay(String body,String out_trade_no,String total_fee,String openId,String basePath){
		UnifiedorderRespData unifiedorderRespData = null;
		try {
			UnifiedorderReqData unifiedorderReqData = new UnifiedorderReqData(body,out_trade_no,total_fee,openId,basePath);
