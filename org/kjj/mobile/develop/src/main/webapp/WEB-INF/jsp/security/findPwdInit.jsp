...
<div class="box box-gray">
		<header class="header">
			<div class="head-content">找回密码</div>
			...
			<form>
				...
				<div id="acountDiv">
					<div class="acount-form">
						<input id="phoneNo" type="text" autofocus="autofocus" placeholder="请输入手机号">
					</div>
		...
		<div class="acount-button" style="display:none">
			<a  href="${ctx}/loginInit">完成</a>
		</div>
	</div>
	
<%@ include file="../common/common_js.jsp"%>
<script type="text/javascript" src="${jsBase}/security/findPwd.js"></script>
</body>
</html>