			...
			<form id="form">
				<div class="form-list">
					...
					<div class="form-center">
						<input type="text" name="mobileOrEmail" id="mobileOrEmail" autocomplete="off" oninput="check()" placeholder="手机号或邮箱">
				...
				<div class="form-list">
					...
					<div class="form-center ">
						<input type="text" name="verifycode" id="verifycode" class="f-special1" value="" maxlength="6" autocomplete="off"/>
				...
				<div class="form-list">
					...
					<div class="form-center">
						<input type="password" name="payPassword" id="password" value="" maxlength="6" autocomplete="off" />
					</div>
				...
				<div class="form-list">
					...
					<div class="form-center">
						<input type="password" id="confirmpassword" name="confirmpass" value="" maxlength="6" autocomplete="off" />
					</div>
