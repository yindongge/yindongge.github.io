			...
			<div class="member-right">
				<div class="mlist information " id="basic" >
					...
					<div class="safeset-tip2">
							温馨提示：激活成功后，您将成为<strong class="red">金牌会员</strong>，享受<strong class="red">更优惠的价格</strong>。 <a target="_blank" href="${ctx}/article/dispatcher/57"> 详情》</a>
					</div>
					<br/>
					<div class="form-list">
						<div class="form-left">
					...
					<div class="form-list">
						...
						<div class="form-right">
							<p id="invitationCodeTip" class="normal">6位或者9位数字</p>
						</div>
					</div>
					<div class="form-list">
						<div class="form-left">
