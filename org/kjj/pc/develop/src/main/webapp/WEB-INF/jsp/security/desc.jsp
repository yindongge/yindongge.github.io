		...
		<div class="container container-width  ">
			...
			<div class="member-right">
				<div class="mlist information " id="basic" >
					...
					<div class="basic-info">
						...
						<div class="basic-right">
							...
							<c:if test="${not empty accountDeposit.payPassword }">
								<a href="${ctx}/accountDeposit/updatePasswordInit">修改支付密码</a>
							</c:if>
						</div>
					</div>
					<div class="basic-info">
				...
				<c:if test="${kjjuser.orgUsers.levelType=='2'}">
					<div class="mlist" style="height:192px;margin-top:10px;">
						<div class="basic-info">
							<div class="basic-left">
						...
						<c:if test="${1==enterprise.status && null != easyInvitation}">
							<div class="basic-info">
								<div class="basic-left">
									<p>统一邀请码：<strong class="red">${easyInvitation.code}</strong>&nbsp;&nbsp;(${easyInvitationStatus})</p>
								</div>
								<div class="basic-right">
									提示：有效期:<fmt:formatDate value="${easyInvitation.startTime}" pattern="yyyy-MM-dd HH:mm:ss" />~<fmt:formatDate value="${easyInvitation.endTime}" pattern="yyyy-MM-dd HH:mm:ss" />
								</div>
							</div>
						</c:if>
						<c:if test="${1==enterprise.status}">
...
<div class="modify modify2 add-basic" id="invitationWin" style="display:none">
		...
		<div class="add-basic-wrapper">
			...
			<div class="add-basic-content">
				<h4 >未使用邀请码</h4>
				<div class="span-item" style="height: 400px;overflow: auto;overflow-x: hidden;" id="invitationdiv">
