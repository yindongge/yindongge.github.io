			...
			<div class="goods-detail">
				<div class="detail-center">
									...
									<div class="dt" style="padding-top:3px;">参加促销：</div>
									 <div class="dd">
										<p class="p2 line-through">
											<span class="price1 gray">${LimitTimeGood.goodsTitle}</span>
											<span class="yellow">
											...
											<span class="daoshu"><i id="countDownEnd" class="reddaoshu"></i></span>
					...
					<c:if test="${orgProductItemAll.orgProductItemAide.markLimitTimeDiscount==true}">
						<div class="price pricerevise">
							<!-- 现在有活动，后台已经判断限时小于个人等级优惠 -->
							<c:if test="${LimitTimeGood ne null and LimitTimeGood.price le orgProductItemAll.orgProductItemAide.sourcePrice}">
								<!-- 个人等级优惠 -->
								<div class="choose-taste choose-special nomargin">
									...
									<div class="dd">
										<p class="p2">
											...
											<span class="money">￥</span> <span class="yellow">
												<c:if test="${LimitTimeGood eq null eq null}">暂无报价</c:if>
												<c:if test="${LimitTimeGood eq null ne null}">
													<fmt:formatNumber type="currency" pattern="0.00" value="${LimitTimeGood.price}"/>
												</c:if>
											</span>
											<span class="daoshu"><i id="limitTimeEnd" class="reddaoshu"></i></span>
							...
							<div class="other_content">
								...
								<div class="ohter_r">
									...
									<c:forEach items="${orgReachList}" var="orgReach">
										<p title="${orgReach.title}"><span class="other_span">${orgReach.label}</span>
											${orgReach.title}
										</p>
									</c:forEach>
								</div>
								...
								<div class="have-content">
									<ul class="ct-listall">
										<c:forEach var="comment" items="${orgGoodsCommentPage.content}">
											<li>
												<div class="ct-left">
													<div class="ct-left-ask">${fn:escapeXml(comment.goodsComment)}</div>
