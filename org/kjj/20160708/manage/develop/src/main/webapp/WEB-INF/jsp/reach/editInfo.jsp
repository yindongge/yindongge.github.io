				...
				<div class="horizontal_wrapper">
					<form id="addInfoForm" action="${ctx}/reach/editInfoData" method="get" class="form-horizontal  media-control">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="name" value="${orgReach.name}" class="form-control" required >
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label"><span class="red">*</span>活动显示标题：</label>
							<div class="col-sm-4">
								<input type="text" name="title" value="${orgReach.title}" class="form-control" required >
							</div>
						</div>
						<div class="form-group">
