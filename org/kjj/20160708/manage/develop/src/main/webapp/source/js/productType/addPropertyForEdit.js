function addTextArea(){
	$("#valueArea").append(
		'<input type="hidden" name="propertyValuesId" value="-1"/>'+
		"<textarea class='form-control'  rows='5' id='textArea' name='propertyValues'/>"			
	);
};
...
function initValue(){
	var propertySelect = '${product_Property.propertySelect}';
	var propertyInputType = '${product_Property.propertyInputType}';
	if(propertySelect == 0){
