...
<div class="container-fluid">
	<form  class="form-inline" id ="pageform" name ="pageform" action="${ctx}/accountGroup/groupSelect" method="post">
		<ul class="breadcrumb">
			<li>您的位置</li>
			<li ><a href="#">会员</a></li>
		...
		<div class="breadcrumb breadcrumb-title">用户组列表</div>
		<table class="table table-hover table-bordered table-striped table-4">
			...
			<tbody>
				...
				<tr  class="icon11 zhekoutext">
					...
					<td>
					    <button type="button" onclick="doSelect('${item.groupId}','${item.groupName}')" class="btn btn-danger btn-xs">选择</button>
					</td>
				</tr>
				</c:forEach>
			</tbody>
