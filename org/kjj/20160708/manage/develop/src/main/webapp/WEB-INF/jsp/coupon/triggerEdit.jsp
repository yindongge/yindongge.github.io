...
<body>
<form class="form-horizontal media-control" id="triggerEdit" action="${ctx}/coupon/triggerEdit" method="post">
<div class="page-wrapper goods-control">
<div class="container-fluid">
	<ul class="breadcrumb">
		<li>您的位置</li>
		<li ><a href="${ctx}/coupon/list">优惠券管理</a></li>
		<li class="active">编辑触发券</li>
	</ul>
	
	<br/>
	
	<div class="group-button">
		<a role="button" class="btn btn-default" href="${ctx}/coupon/giveInit/${coupon.couponId}">普通券</a>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
					...
					<div class="col-sm-12">
						<div class="td-item">
							<div class="td-item-right">
								<input type="hidden" name="discountId" value="${coupon.couponId}"/>
								<input type="hidden" name="typeId" value="2"/>
								<input type="hidden" name="id" value="${orgDiscountTrigger.id}"/>
								<input type="hidden" name="status" value="${orgDiscountTrigger.status}"/>
								<input type="hidden" id="couponStartTime" value="<fmt:formatDate type='both' value='${coupon.startTime}' pattern="yyyy-MM-dd HH:mm:ss"/>"/>
								<input type="hidden" id="couponEndTime" value="<fmt:formatDate type='both' value='${coupon.endTime}' pattern="yyyy-MM-dd HH:mm:ss"/>"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="col-sm-4">
					<input type="text" class="form-control date" name="startTime" id="startTime" value="<fmt:formatDate type='both' value='${orgDiscountTrigger.startTime}' pattern="yyyy-MM-dd HH:mm:ss"/>"
						required data-bv-notempty-message="开始时间不能为空"/>
					</div>
					<div class="col-sm-1">-</div>
					<div class="col-sm-4">
					<input type="text" class="form-control date" name="endTime" id="endTime" value="<fmt:formatDate type='both' value='${orgDiscountTrigger.endTime}' pattern="yyyy-MM-dd HH:mm:ss"/>"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="col-sm-3">
						<input type="text" class="form-control col-sm-3" name="triggerAmount" value="${orgDiscountTrigger.triggerAmount}"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="col-sm-12">
						<textarea rows="5" style="width:50%;resize: none;" name="reason" maxlength="200" onkeyup="checkTextAreaLength(this,200)" onblur="checkTextAreaLength(this,200)">${orgDiscountTrigger.reason}</textarea>
					</div>
				</div>
			</div>
			</div>
	...
	<p class="text-center margin5">
		<a type="button" class="btn btn-primary" role="button" href="${ctx}/coupon/triggerList" style="margin-right:30px">返回</a>
...
<script src="${jsBase}/coupon/triggerEdit.js" type="text/javascript"></script>
</body>
</html>