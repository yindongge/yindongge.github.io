...
<div class="container-fluid">
	<div class="page-wrapper">
		<div class="container-fluid">
			...
			<div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
			   ...
			   <a href="#" class="btn btn-info" role="button">板块区</a>
		    </div>
			<!-- 切换 -->
			<form class="form-inline" id="mobilePageform" name ="mobilePageform" action="../mobilePage/saveMobilePage" method="post">
	...
	<script src="${jsBase}/mobilePage/mobilePageAdd.js" type="text/javascript"></script>
</div>
</body>
</html>
