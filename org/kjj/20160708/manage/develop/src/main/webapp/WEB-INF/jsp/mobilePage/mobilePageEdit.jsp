...
<div class="container-fluid">
	<div class="page-wrapper">
		<div class="container-fluid">
			...
			<!-- 切换 -->
			<form class="form-inline" id="mobilePageform" name ="mobilePageform" action="../mobilePage/updateMobilePage" method="post" enctype="multipart/form-data">
	...
	<script src="${jsBase}/mobilePage/mobilePageEdit.js" type="text/javascript"></script>
</div>
</body>
