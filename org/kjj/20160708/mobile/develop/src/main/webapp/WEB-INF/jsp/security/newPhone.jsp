		...
		<div class="acount-control">
			<form id="formBind">
				...
				<div class="acount-form no-border">
					<input type="text" id="verifycode" name="verifycode" maxlength="4" placeholder="请输入验证码">
					<a href="javascript:void(0);" id="aIdentifyCode" class="acount-check ">获取验证码</a>
					<!-- 上边有倒数 -->
				</div>
			</form>
		</div>
		<div class="acount-button">
			<a href="javascript:void(0)" id="btnBind">完成</a>
		</div>
		<!-- end center -->
		<footer class="footer">
