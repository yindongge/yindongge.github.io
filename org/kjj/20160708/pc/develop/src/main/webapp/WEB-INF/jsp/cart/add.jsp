...
<form id="cart" action="${ctx}/cart/list" method="get">
	<div class="container">
		<div class="success-add">
			<div class="successadd-left">商品已经成功加入购物车</div>
			<div class="successadd-button">
				<button type="submit" class="btn btn-warning">去购物车结算</button>
			</div>
			<div class="successadd-right">
				<p>您还可以<a href="javascript:history.go(-1);">返回继续挑选商品</a></p>
			</div>
		</div>
	</div>
</form>
