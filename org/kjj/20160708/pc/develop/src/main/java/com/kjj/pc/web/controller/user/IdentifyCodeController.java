...
public class IdentifyCodeController { 
    ...
    @RequestMapping("/identifyEnterpriseRegCode")
    public void getEnterpriseRegCode(HttpSession session, HttpServletResponse resp)throws IOException { 
    	createCode(session, resp, SessionConstant.SESSION_ENTERPRISE_IDENTITY_CODE);
    }
    
    public void createCode(HttpSession session, HttpServletResponse resp, String sessionKey) throws IOException{
    	// 定义图像buffer  
