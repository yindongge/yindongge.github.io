...
function addFloor(){
	...
	//htmlstr+="<input style=\"margin-left:20px\" type=\"button\" class=\"col-sm-2\" onclick=\"addProduct('class_"+fid+"');\" value=\"添加产品\"/></div>";
	htmlstr+="</div>";
	
	htmlstr+="<div class=\"row\" id=\"product_"+fid+"\" style=\"margin-top:5px;\">";
	
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_1\" onclick=\"addProduct2(\'" + fid + "\',\'1\')\" width=\"80\"  height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'1\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_1\" name=\"product_"+fid+"_1\"></input></div>";
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_2\" onclick=\"addProduct2(\'" + fid + "\',\'2\')\"  width=\"80\"  height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'2\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_2\" name=\"product_"+fid+"_2\"></input></div>";
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_3\" width=\"80\" onclick=\"addProduct2(\'" + fid + "\',\'3\')\"   height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'3\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_3\" name=\"product_"+fid+"_3\"></input></div>";
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_4\" width=\"80\" onclick=\"addProduct2(\'" + fid + "\',\'4\')\"   height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'4\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_4\" name=\"product_"+fid+"_4\"></input></div>";
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_5\" width=\"80\" onclick=\"addProduct2(\'" + fid + "\',\'5\')\"   height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'5\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_5\" name=\"product_"+fid+"_5\"></input></div>";
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_6\" width=\"80\" onclick=\"addProduct2(\'" + fid + "\',\'6\')\"   height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'6\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_6\" name=\"product_"+fid+"_6\"></input></div>";
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_7\" width=\"80\" onclick=\"addProduct2(\'" + fid + "\',\'7\')\"   height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'7\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_7\" name=\"product_"+fid+"_7\"></input></div>";
	htmlstr+="<div class=\"col-sm-2\" style=\"margin-left:15px\"><img src=\"\" id=\"product_" + fid + "_img_8\" width=\"80\" onclick=\"addProduct2(\'" + fid + "\',\'8\')\"   height=\"80\" alt=\"点击选择商品\"></img><input type=\"button\" style=\"margin-left:20px\" onclick=\"removeProduct(\'"+fid+"\',\'8\')\" value=\"删除\"/><input type=\"hidden\" id=\"product_"+fid+"_8\" name=\"product_"+fid+"_8\"></input></div>";
	...
	$('.btn.btn-info.product').on('click',function(){
		var htmlstrNew="";
		var rep="product_"+fid+"_img_";
		var lastItemId=$(this).prev().find('img').attr('id').replace(rep,"");
...
function validateForm(shopId){
	$.ajax({
		type : "POST",
		dataType : "json",
		url : "../shopPage/pageIsOnly?shopId=" + shopId,
		data : "",
		success : function(data) {
			if (data.code == 200) {
				// 提交表单
