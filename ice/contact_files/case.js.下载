...
$("#navAbout").find("li").eq(4).siblings().hover(function(){
	$("#navAbout").find("li").eq(4).stop().animate({
		left:this.offsetLeft,
		width:this.offsetWidth
	})
},function(){
...
$("#navContact").find("li").eq(4).siblings().hover(function(){
	$("#navContact").find("li").eq(4).stop().animate({
		left:this.offsetLeft,
		width:this.offsetWidth
	})
},function(){
